		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload list of employees",
									"targetURL": "#Uploadlistofemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Uploadlistofemployees-display": {
								"semanticObject": "Uploadlistofemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=infopulse.cv.EmployeeListUpload",
									"url": sap.ui.require.toUrl("infopulse/cv/EmployeeListUpload")
								}
							}
						}
					}
