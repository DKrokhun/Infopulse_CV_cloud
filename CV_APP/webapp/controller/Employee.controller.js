sap.ui.define([
	...
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function (BaseController, Sorter, Filter, FilterOperator, formatter, JSONModel, MessageBox, MessageToast) {
	"use strict";
	...
	return BaseController.extend("infopulse.cv.infopulse-cvapp-ui.controller.Employee", {
		...
		confirm: function (oEvent) {
			...
			var mParameters = {
				context: {},
				success: function () {
					sap.m.MessageBox.show("Status updated.");
				},
				error: function () {
		...
		handlePress: function (oEvent) {
			...
			this.getModel().read(sUrl, {
				success: function (oData) {
					...
					var blob = new Blob([sFileContent], {
						type: sFileType
					});
